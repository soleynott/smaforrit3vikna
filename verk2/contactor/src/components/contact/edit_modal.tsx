...
import { requestCameraPermission, requestMediaLibraryPermission } from "@/src/services/image-service";
        ...
        return (
            <Modal title="Edit Contact" isOpen={props.isOpen} closeModal={props.closeModal}>
                <ScrollView style={styles.formContainer}>
                    ...
                    <TouchableOpacity
                        style={{ ...styles.createButton, backgroundColor: "#e74c3c", marginTop: 10 }}
                    ...
                    <TouchableOpacity
                        style={{ ...styles.createButton, backgroundColor: "#95a5a6", marginTop: 10 }}
                        ...
                        renderItem={({ item }) => (
                            ...
                            >
                                ...
                                <View style={{ flex: 1, justifyContent: "center" }}>
                                    ...
                                    <Text style={{ fontSize: 12, color: "#666" }}>{item.phoneNumber}</Text>
                                </View>
